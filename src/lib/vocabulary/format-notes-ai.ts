...
5. Pair singular and plural forms of the same case on the same row.
6. Raw dumps often interleave labels and forms across lines — regroup by case.
7. Keep non-table notes as paragraph / heading / bulletList / orderedList blocks.
